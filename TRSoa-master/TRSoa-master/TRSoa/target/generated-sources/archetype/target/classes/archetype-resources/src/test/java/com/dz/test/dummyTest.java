...
public class dummyTest {
    ...
    public void testBcrypt(){
       BCryptPasswordEncoder bCEncoder =  new BCryptPasswordEncoder();
        ...
        System.out.println(bCEncoder.matches("1", "${symbol_dollar}2a${symbol_dollar}10${symbol_dollar}buNS49tuUVqCzKcAyqxAT.73H/9I44C43B4iJcq4IK0dB3uqodb0G"));
        assertTrue(true);
    }
    ...
    public void testTsInputKey() {
        ...
        assertTrue(input.matches("^[0-9]+_[0-9]+_[A-Za-z]+${symbol_dollar}"));
    }
