...
import ${package}.exception.TimesheetException;
import ${package}.service.activiti.timesheet.TsActivitiService;
...
//                }
    ...
    private static final Pattern VALID_TS_INPUT_KEY = Pattern.compile("^[0-9]+_[0-9]+_[A-Za-z]+${symbol_dollar}");
