...
public interface WeatherSoap {
     ...
     * 
     * @return
     *     returns net.antra.deptemp.ws.ArrayOfWeatherDescription
     */
    ...
    @RequestWrapper(localName = "GetWeatherInformation", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "net.antra.deptemp.ws.GetWeatherInformation")
    @ResponseWrapper(localName = "GetWeatherInformationResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "net.antra.deptemp.ws.GetWeatherInformationResponse")
     ...
     * @param zip
     * @return
     *     returns net.antra.deptemp.ws.ForecastReturn
     */
    ...
    @RequestWrapper(localName = "GetCityForecastByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "net.antra.deptemp.ws.GetCityForecastByZIP")
    @ResponseWrapper(localName = "GetCityForecastByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "net.antra.deptemp.ws.GetCityForecastByZIPResponse")
     ...
     * @param zip
     * @return
     *     returns net.antra.deptemp.ws.WeatherReturn
     */
    ...
    @RequestWrapper(localName = "GetCityWeatherByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "net.antra.deptemp.ws.GetCityWeatherByZIP")
    @ResponseWrapper(localName = "GetCityWeatherByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "net.antra.deptemp.ws.GetCityWeatherByZIPResponse")
